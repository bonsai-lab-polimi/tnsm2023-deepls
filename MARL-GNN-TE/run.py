...
flags.DEFINE_string("base_dir", "logs", "Base directory to host all required sub-directories.")
flags.DEFINE_string("network", "logs", "Base directory to host all required sub-directories.")
flags.DEFINE_multi_string("gin_files", ["configs/general.gin", "configs/ppo.gin"], "List of paths to gin configuration files")
