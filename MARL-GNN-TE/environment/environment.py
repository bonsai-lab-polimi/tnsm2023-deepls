...
DEFAULT_EDGE_ATTRIBUTES = {"increments": 1, "reductions": 1, "weight": 0.0, "traffic": 0.0}
...
class Environment(object):
    ...
    def generate_graph(self):
        ...
        self.G.add_node(
            "graph_data", link_ids_dict=link_ids_dict, incoming_links=incoming_links, outcoming_links=outcoming_links
        )
    ...
    ****************************************************************************
    ...
    def _distribute_link_traffic(self, routing=None):
        ...
        if self.routing == "sp":
            ...
            visited_pairs = set()
            self.next_hop_dict = {
                i: {j: set() for j in range(self.G.number_of_nodes() - 1) if j != i}
